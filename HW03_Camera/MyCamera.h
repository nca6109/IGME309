...
class MyCamera : BTXs::Camera
{
	...
	//
	//BTX_CAMERAMODE m_nMode = BTX_CAMERAMODE::CAM_PERSP; //Sets the mode the camera will display
	//
...
public:
	...
	*/
	...
	OUTPUT: ---
	*/
	void SetCameraMode(BTXs::eCAMERAMODE a_nMode = BTXs::eCAMERAMODE::CAM_PERSP);
	...
	*/
	BTXs::eCAMERAMODE GetCameraMode(void);
