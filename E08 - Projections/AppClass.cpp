...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_X * 30.0f, vector3(), AXIS_Z * -1.0f);
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * -15.0f, vector3(), vector3(0.0f,1.0f,0.0f));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * -15.0f, vector3(), vector3(0.0f, 1.0f, 0.0f));
	...
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f,0.0f,10.0f), vector3(), vector3(0.0f, -1.0f, 0.0f));
		break;
	}
